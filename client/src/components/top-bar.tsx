    ...
    <header className="sticky top-0 z-50 flex h-16 items-center gap-4 border-b bg-background px-4">
      ...
      <DropdownMenu>
        <DropdownMenuTrigger asChild>
          <Button variant="ghost" className="gap-2" data-testid="button-tenant-switcher">
      ...
      <div className="flex items-center gap-2">
        <DropdownMenu>
          <DropdownMenuTrigger asChild>
            <Button variant="default" size="sm" className="gap-2" data-testid="button-quick-add">
        ...
        {isOffline && (
          <Badge variant="secondary" className="gap-1" data-testid="badge-offline">
